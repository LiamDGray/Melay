...
import tech.mattico.melay.view.widget.MelayTextView.Companion.SIZE_PRIMARY
import tech.mattico.melay.view.widget.MelayTextView.Companion.SIZE_SECONDARY
import tech.mattico.melay.view.widget.MelayTextView.Companion.SIZE_TERTIARY
import tech.mattico.melay.view.widget.MelayTextView.Companion.SIZE_TOOLBAR
 ...
 */
class MelayEditText @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : EditText(context, attrs) {
    ...
    init {
        if (!isInEditMode) {
            ...
            context.obtainStyledAttributes(attrs, R.styleable.MelayEditText)?.run {
                val colorAttr = getInt(R.styleable.MelayEditText_textColor, -1)
                val colorHintAttr = getInt(R.styleable.MelayEditText_textColorHint, -1)
                val textSizeAttr = getInt(R.styleable.MelayEditText_textSize, -1)
