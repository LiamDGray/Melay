...
import tech.mattico.melay.utils.filter.ConversationFilter
...
class MainViewModel : MelayViewModel<MainView, MainState>(MainState()) {
    ...
    override fun bindView(view: MainView) {
        ...
        view.drawerItemIntent
                ...
                .doOnNext { if (it == DrawerItem.PLUS) navigator.showMelaysmsPlusActivity() }
